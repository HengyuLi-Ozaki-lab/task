...
!     ----- deallocate arrays -----
      ...
      IF(ALLOCATED(NITMAX)) DEALLOCATE(NITMAX)
      ...
      IF(ALLOCATED(PSIX))  DEALLOCATE(PSIX)
      IF(ALLOCATED(SI))  DEALLOCATE(SI)
      IF(ALLOCATED(CU1))  DEALLOCATE(CU1)
      IF(ALLOCATED(CU2))  DEALLOCATE(CU2)
      IF(ALLOCATED(CU3))  DEALLOCATE(CU3)
      IF(ALLOCATED(U4))  DEALLOCATE(U4)
      IF(ALLOCATED(U5))  DEALLOCATE(U5)
      IF(ALLOCATED(U6))  DEALLOCATE(U6)
      IF(ALLOCATED(U7))  DEALLOCATE(U7)
      IF(ALLOCATED(U8))  DEALLOCATE(U8)
      IF(ALLOCATED(U9))  DEALLOCATE(U9)
      IF(ALLOCATED(U10))  DEALLOCATE(U10)

      IF(ALLOCATED(NCRMAX))  DEALLOCATE(NCRMAX)
      IF(ALLOCATED(CECR))  DEALLOCATE(CECR)
      IF(ALLOCATED(RKCR))  DEALLOCATE(RKCR)
      IF(ALLOCATED(RCR))  DEALLOCATE(RCR)
      IF(ALLOCATED(RRMIN))  DEALLOCATE(RRMIN)
      IF(ALLOCATED(RRMAX))  DEALLOCATE(RRMAX)

      IF(ALLOCATED(ARGB))  DEALLOCATE(ARGB)
      IF(ALLOCATED(RBCR))  DEALLOCATE(RBCR)
      IF(ALLOCATED(CEB))  DEALLOCATE(CEB)
      IF(ALLOCATED(RKB))  DEALLOCATE(RKB)
      IF(ALLOCATED(RBB))  DEALLOCATE(RBB)
