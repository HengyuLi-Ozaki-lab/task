...
CONTAINS
  ...
  SUBROUTINE deallocate_trcomm_profile
    ...
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: A begin"; FLUSH(0); END IF
    ...
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: B after AJ-AJOH block"; FLUSH(0); END IF
    ...
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: C after ETA-AV block"; FLUSH(0); END IF
    ...
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: D after GR* block"; FLUSH(0); END IF
    ...
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: E after RHO block"; FLUSH(0); END IF
    ...
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: I after *U block"; FLUSH(0); END IF
    DEALLOCATE(PNSSO,PTSO,PNSSAO,PTSAO)
    IF (trace_on) THEN; WRITE(0,'(A)') "profile: J end"; FLUSH(0); END IF
