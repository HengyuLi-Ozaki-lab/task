...
CONTAINS
  ...
  SUBROUTINE  READ_ADF11(adas_adf11_filename,IERR)
    ...
    IF(ALLOCATED(DRCOF))  DEALLOCATE(DRCOF)
    IF(ALLOCATED(DDENSL)) DEALLOCATE(DDENSL)
    IF(ALLOCATED(DTEMPL)) DEALLOCATE(DTEMPL)
    IF(ALLOCATED(DRCOFL)) DEALLOCATE(DRCOFL)
    IF(ALLOCATED(FX))     DEALLOCATE(FX)
    IF(ALLOCATED(FY))     DEALLOCATE(FY)
    IF(ALLOCATED(FXY))    DEALLOCATE(FXY)
    RETURN
...
!-----------------------------------------------------------------------
      ...
      IF(ILIST.EQ.0) THEN
         IF(ALLOCATED(NPTN))   DEALLOCATE(NPTN)
         IF(ALLOCATED(NPTNC))  DEALLOCATE(NPTNC)
         IF(ALLOCATED(IPTNLA)) DEALLOCATE(IPTNLA)
         IF(ALLOCATED(IPTNA))  DEALLOCATE(IPTNA)
         IF(ALLOCATED(IPTNCA)) DEALLOCATE(IPTNCA)
         IF(ALLOCATED(ICNCTV)) DEALLOCATE(ICNCTV)
         IF(ALLOCATED(ISPPR))  DEALLOCATE(ISPPR)
         IF(ALLOCATED(ISPBR))  DEALLOCATE(ISPBR)
         IF(ALLOCATED(ISSTGR)) DEALLOCATE(ISSTGR)
         RETURN
      END IF
