...
9000 CONTINUE
    IF(ALLOCATED(RHOFL)) DEALLOCATE(RHOFL)
    IF(ALLOCATED(RNEFL)) DEALLOCATE(RNEFL)
    IF(ALLOCATED(RTEFL)) DEALLOCATE(RTEFL)
    IF(ALLOCATED(RTIFL)) DEALLOCATE(RTIFL)
    IF(ALLOCATED(URNEFL)) DEALLOCATE(URNEFL)
    IF(ALLOCATED(URTEFL)) DEALLOCATE(URTEFL)
    IF(ALLOCATED(URTIFL)) DEALLOCATE(URTIFL)
