...
30     FORMAT('$',A,I7,'$')
    ...
    IF(ALLOCATED(BSQ)) DEALLOCATE(BSQ)
    IF(ALLOCATED(R12)) DEALLOCATE(R12)
    IF(ALLOCATED(Z12)) DEALLOCATE(Z12)
    IF(ALLOCATED(PHIM)) DEALLOCATE(PHIM)
    IF(ALLOCATED(PHIM2)) DEALLOCATE(PHIM2)
    IF(ALLOCATED(RGSQRT)) DEALLOCATE(RGSQRT)
...
!     ****** SETUP TRANSFORMATION TO ORIGINAL AXES ******
    ...
    IF(ALLOCATED(GXPLOT)) DEALLOCATE(GXPLOT)
    IF(ALLOCATED(GYPLOT)) DEALLOCATE(GYPLOT)
    IF(ALLOCATED(GRTHET)) DEALLOCATE(GRTHET)
    IF(ALLOCATED(GZTHET)) DEALLOCATE(GZTHET)
    IF(ALLOCATED(GFUNC)) DEALLOCATE(GFUNC)
    IF(ALLOCATED(GR1)) DEALLOCATE(GR1)
    IF(ALLOCATED(GZ1)) DEALLOCATE(GZ1)
    IF(ALLOCATED(KA1)) DEALLOCATE(KA1)
