...
1   WRITE(6,*) ' ## INPUT GSTR : R/AEPNB/ATMN  CPM/P/123  CP/J', &
               '  P/F/SBQ23J   R/G  S'
...
9000 CONTINUE
    IF(ALLOCATED(GX1)) DEALLOCATE(GX1)
    IF(ALLOCATED(GX2)) DEALLOCATE(GX2)
    IF(ALLOCATED(GYS)) DEALLOCATE(GYS)
    IF(ALLOCATED(GY)) DEALLOCATE(GY)
    IF(ALLOCATED(GY1)) DEALLOCATE(GY1)
    IF(ALLOCATED(GY2)) DEALLOCATE(GY2)
...
1   CONTINUE
    ...
    IF(ALLOCATED(GXR)) DEALLOCATE(GXR)
    IF(ALLOCATED(GY)) DEALLOCATE(GY)
