...
!   ***********************************************
  ...
  SUBROUTINE wm_taem
    ...
    EXTERNAL LAPACK_DSBTRD,LAPACK_DSTEBZ
...
1000 CONTINUE
    ...
    IF(ALLOCATED(CWALF)) DEALLOCATE(CWALF)
    IF(ALLOCATED(CWALFK)) DEALLOCATE(CWALFK)
    IF(ALLOCATED(RNX)) DEALLOCATE(RNX)
    IF(ALLOCATED(RTPRX)) DEALLOCATE(RTPRX)
    IF(ALLOCATED(RTPPX)) DEALLOCATE(RTPPX)
    ...
    IF(ALLOCATED(NGY)) DEALLOCATE(NGY)
    IF(ALLOCATED(IBLOCK)) DEALLOCATE(IBLOCK)
    IF(ALLOCATED(ISPLIT)) DEALLOCATE(ISPLIT)
...
!**********************************************************************
  ...
  SUBROUTINE GSGRAF(GX,GY,NGY,NXMAX,NXM,GXMIN1,GXMAX1,GYMIN1,GYMAX1)
    ...
    REAL,INTENT(IN):: GX(NXM),GY(NXM,*)
    INTEGER,INTENT(IN):: NGY(NXM)
    REAL,INTENT(IN):: GXMIN1,GXMAX1,GYMIN1,GYMAX1
    EXTERNAL GQSCAL,PAGES,SETCHS,GDEFIN,SETLIN,GFRAME,GSCALE,GVALUE
    EXTERNAL SETMKS,GPLOTP,PAGEE
    INTEGER:: NGULEN

    
    REAL:: GXMIN,GXMAX,GXSTEP,GYMIN,GYMAX,GYSTEP
    INTEGER:: NX,NY
