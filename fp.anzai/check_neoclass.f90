...
!======================================================================
  ...
  !== ref
  ! 1/J * K * dfdx_i dV(volume) from "concerto for nabla" by ota koichi (2015)[1]
  ! Energy transfer time "Gendai Plasma rikogaku" 1979 Ohmsha [2]
  ! "Plasma Confinement" R.D.Hazeltine and J.D.Meiss 1992 Addison-Wesly Publishing Companey
