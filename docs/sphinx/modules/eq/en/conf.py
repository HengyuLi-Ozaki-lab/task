"""Sphinx configuration for modules/eq (English)."""
...
language = "en"
project = "TASK/EQ — Equilibrium"
html_title = "TASK/EQ — Equilibrium"
html_short_title = "EQ (EN)"
...
latex_documents = [("index", "task_eq_manual.tex", project, author, "manual")]
