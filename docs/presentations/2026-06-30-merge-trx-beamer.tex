...
\end{block}
$\Rightarrow$ migrating DT to \C{model\_pnf} shifts \C{SNF} $\sim$1\% for \textbf{zero physics gain};
...
validated vs a bpsi-\C{trx} reference at 1e-10. \C{MDLNF} is \emph{not} retired.
\end{block}
