...
% Standard packages only (beamer, booktabs, amsmath) -- no external theme needed.
...
\begin{block}{Goal}
Bring the \emph{latest upstream base} onto the \emph{modernized} fork \textbf{without regression},
then make \C{tr} the single canonical transport module by porting \textsc{trx}'s newer fusion physics.
\end{block}
\end{frame}
